...
Текущая версия: v1.9.3. Продукт прошёл путь от MVP (v1.0) до монетизированного SaaS с премиум-подпиской (ЮKassa), административной панелью и полноценной системой аутентификации (NextAuth v5).
