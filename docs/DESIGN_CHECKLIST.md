...
- [x] Зоны **Разделы** (табы) и **Действия** (кнопки) — визуально разделены
- [x] Share (Web Share / диалог со ссылкой) и Copy (текст активной вкладки) — разные сценарии
- [x] Перевод на русский (EN) одной кнопкой при `language=en`
- [x] Markdown рендер
...
- [x] Ширина 280–320px
- [x] Табы Недавние / Сохранённые / **Ссылки** (шары аккаунта) / Корзина — «Ссылки» через API; синк локальной истории между устройствами — опционально
